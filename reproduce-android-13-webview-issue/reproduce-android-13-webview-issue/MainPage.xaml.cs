...
namespace reproduce_android_13_webview_issue
{
    public partial class MainPage : ContentPage
    {
        ...
        {
            InitializeComponent();
            rteditor.HtmlText = TestHtml01; // PASS
            // rteditor.HtmlText = TestHtml02; // FAIL
            // rteditor.HtmlText = TestHtml03; // FAIL
            // rteditor.HtmlText = TestHtml04;  // PASS
            ...
            try
            {
                ...
                switch (e.PropertyName)
                {
                    default:
                        ...
                        Debug.WriteLine(rteditor.GetHtmlString());
                        break;
                }
            }
            catch (Exception ex)
